...
const LandingPage = () => {
        ...
        const mockCourses = [
          {
            ...
            description:
              "Master the fundamentals of swing dancing in this comprehensive course.",
            style: "Lindy Hop",
            level: "Beginner",
          },
          {
            ...
            description:
              "Discover the soulful moves of Rhythm and Blues dancing.",
  ...
  const testimonials = [
    {
      ...
      content:
        "The instructors break down complex moves in a way that's easy to understand. After 3 months, I'm confidently dancing at social events!",
    },
    {
      id: 2,
      name: "Marcus Chen",
      ...
      content:
        "The advanced techniques taught here have completely transformed my solo jazz game. The attention to historical context is unmatched.",
    },
  ];
  ...
  const practicePlaylists = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/4088012/pexels-photo-4088012.jpeg",
    },
  ];
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    if (!domain || !domain.includes(".")) {
      toastError("Please enter a valid email domain (e.g., @gmail.com)");
      return;
    }
    ...
    try {
      ...
      toastSuccess("Failed to subscribe. Please try again.");
    } finally {
      setLoading(false);
    }
  };
        ...
        >
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join our vibrant community and master the art of dance through
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {historicImages.map((image, index) => {
                // Set a different objectPosition for each image
                let objectPosition;
                if (index === 0) objectPosition = "50% 25%"; // Image 1
                if (index === 1) objectPosition = "50% 10%"; // Image 2
                if (index === 2) objectPosition = "50% 5%"; // Image 3
                if (index === 3) objectPosition = "50% 15%"; // Image 4
        ...
        <section id="extras" className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-white/90">
                Enhance your dance journey with interactive tools
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="prose prose-lg text-white/90">
                  <p>
                    Take your dancing to the next level with personalized
                    one-on-one instruction. Whether you're preparing for a
                    special event, working on specific techniques, or seeking
                    detailed feedback, private lessons offer the focused
                    attention you need.
                  </p>
                  <p>During these sessions, we'll work together to:</p>
